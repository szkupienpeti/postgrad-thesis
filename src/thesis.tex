...
% Own content
\include{content/bevezetes}
\include{content/hatterismeretek}
\include{content/kutatasmodszertan}
\include{content/eredmenyek}
\include{content/kovetkeztetesek}
\include{content/osszegzes}
