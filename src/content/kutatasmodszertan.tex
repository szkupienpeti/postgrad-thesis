...
Ahogyan szinte az egész világot, a szoftverfejlesztést is alaposan felforgatta a generatív mesterséges intelligencia. 
...
Összesen 11 résztvevővel zajlottak a beszélgetések, akiket a kezelhető létszám érdekében kettéosztottam. A beosztás során igyekeztem hasonló szakmaitapasztalat-eloszlást kialakítani a két csoportban. A panelbeszélgetések adatait a \ref{tab:panelek}. táblázat tartalmazza.

\begin{table}[htbp]
	\centering
	\caption{Iparági panelbeszélgetések adatai. (Saját szerkesztés.)}
	\label{tab:panelek}
	\begin{tabular}{p{2.4cm} p{1.8cm} p{3.3cm} p{2.2cm} p{2cm}}
		...
		\multirow[t]{5}{*}{\textbf{2025. 11. 13.}} 
		& \multirow[t]{5}{*}{90 perc}
		...
		\multirow[t]{6}{*}{\textbf{2025. 11. 14.}} 
		& \multirow[t]{6}{*}{75 perc}
...
\begin{table}[htbp]
	\centering
	\caption{Akadémiai interjú adatai. (Saját szerkesztés.)}
	\label{tab:egyetemi-interju}
	\begin{tabular}{p{2.4cm} p{1.8cm} p{3.3cm} p{2.2cm} p{2.5cm}}
		\toprule
